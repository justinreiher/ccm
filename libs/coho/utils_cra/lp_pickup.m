...
% NOTE: lp_pickup is function from CRA. I don't want CCM to be depend on CRA, so copy the code here. 
if(isempty(lp))
  return;
end
...
% I don't want to copy the lp_create function again
lp = struct('A',projA,'b',projb,'Aeq',projAeq,'beq',projbeq,'isnorm',lp.isnorm);
