classdef TWO_FLOP_PSEUDO_NMOS_SYNC < circuit
    ...
    properties (GetAccess = 'public', SetAccess = 'private')
        vref,vdd,gnd,d,clk,clkbar; q,qbar; %Input ; Output
    end
    
    methods
        function this = TWO_FLOP_PSEUDO_NMOS_SYNC(name,wid,rlen)
            ...
            pNmos_ffMaster = PSEUDO_NMOS_FF('PSNff_M',widMaster,rlenMaster); this.add_element(pNmos_ffMaster);
            pNmos_ffSlave  = PSEUDO_NMOS_FF('PSNff_S',widSlave,rlenSlave); this.add_element(pNmos_ffSlave);
            ...
            this.connect(dinBar_buf,dinBuf.i,dinBarBuf.o,pNmos_ffMaster.dbar);
            ...
            this.connect(this.vref,pNmos_ffMaster.vref,pNmos_ffSlave.vref);
