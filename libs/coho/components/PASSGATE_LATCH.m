% Definition of a PASSGATE_LATCH with PASSGATE elements and INV4 elements
%
...
% E.g. pgLatch = PASSGATE_LATCH('pg0',450e-7,1) creates a passgate latch
% with all transistor widths set to 450nm.
