...
echo "====Step0: Set environment variable CCM_HOME====" 
CCM_HOME=`pwd`
export CCM_HOME
echo $CCM_HOME
echo "" 

echo "====Step1: Generating CCM configuration file ====" 
cd $CCM_HOME
...
echo "You can update the configurations later by editing ccm_info.m file."

echo ""
echo "COHO Circuit Modeling Tool Installed!" 
echo ""
